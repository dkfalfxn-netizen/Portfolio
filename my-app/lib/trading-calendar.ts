 ...
 *
 * ⚠️  연간 유지보수 (매년 1월 초 갱신 권장)
 *   KRX  휴장일: https://www.krx.co.kr → 시장정보 → 휴장일
 *   NYSE 휴장일: https://www.nyse.com/markets/hours-calendars
 *
 * 갱신 체크리스트:
 *   1. 설날·추석 연휴 (음력 기준, 대체공휴일 포함)
 *   2. 공휴일이 토/일과 겹칠 때 대체공휴일
 *   3. 연말(12/31) KRX 관행 휴장
 *   4. NYSE 크리스마스·독립기념일 조기 마감일 (필요 시 별도 처리)
 */
...
const KRX_CLOSED = new Set<string>([
  ...
  "2026-05-05", // 어린이날
  "2026-05-25", // 부처님오신날
  "2026-06-06", // 현충일 (토요일 — 대체공휴일 없음, 당일만 해당 시 제거)
  "2026-08-17", // 광복절 대체공휴일 (8/15가 토요일)
  "2026-09-24", // 추석 전날
  "2026-09-25", // 추석
  "2026-09-28", // 추석 대체공휴일 (9/26 다음날이 토요일 → 월요일 대체)
